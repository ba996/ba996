...
function over(param){
    if(param == 1){
        $("#star1").attr("src","../image/star_red.png");//第一颗星星亮起来，下面以此类推
        $("#message").html("很差");//设置提示语，下面以此类推
    }else if(param == 2){
        $("#star1").attr("src","../image/star_red.png");
        $("#star2").attr("src","../image/star_red.png");
        $("#message").html("比较差");
    }else if(param == 3){
        $("#star1").attr("src","../image/star_red.png");
        $("#star2").attr("src","../image/star_red.png");
        $("#star3").attr("src","../image/star_red.png");
        $("#message").html("一般");
    }else if(param == 4){
        $("#star1").attr("src","../image/star_red.png");
        $("#star2").attr("src","../image/star_red.png");
        $("#star3").attr("src","../image/star_red.png");
        $("#star4").attr("src","../image/star_red.png");
        $("#message").html("比较好");
    }else if(param == 5){
        $("#star1").attr("src","../image/star_red.png");
        $("#star2").attr("src","../image/star_red.png");
        $("#star3").attr("src","../image/star_red.png");
        $("#star4").attr("src","../image/star_red.png");
        $("#star5").attr("src","../image/star_red.png");
        $("#message").html("很好");
    }
...
function click(param){
    time++;//记录打分次数
    check = param;//记录当前打分
    document.getElementById("evaGrade").value=check;
    out();//设置星星数
}